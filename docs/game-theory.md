...
- **§8 deferred (not built):** the **thread-relative analyst-prompt rewrite** (§8.5 integrity), the **hot-extension** (§8.1), the losing-side **standout** nod (§8.3), and **feed/domain card** countdown+concluded states.
