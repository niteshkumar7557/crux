        ...
        <div>
          <div className="flex justify-between">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-label text-[12px] text-tertiary uppercase tracking-widest mb-0.5 mx-1 block">
                {domain}
              </span>
            </div>
            <div>
              <span className="font-label uppercase text-[10px] text-gray-400 bg-gray-500/10 px-1.5 py-1">
                {time}
              </span>
            </div>
          </div>
