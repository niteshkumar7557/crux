...
/**
 * §15: "Main Stage size — ~4 + the Motion of the Day". This is the ~4: the
 ...
 * this function is the tested motion of the formula that SQL mirrors.
 */
